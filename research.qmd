...
::: {.page-lede}
My research advances a sequencing perspective on entrepreneurial development: founders exercise discretion over the timing of developmental milestones such as external financing and customer validation, and this sequencing has implications for a venture's subsequent development and performance.
:::

## Working Papers

::: {.paper-card .featured-paper}
### Strategic Delay in Venture Financing: The Temporal Allocation of Entrepreneurial Learning

**Job Market Paper**

My job market paper examines whether founders exercise discretion over when to accept venture capital and the implications for the venture's subsequent developmental path and performance. I introduce a measure of discretion, strategic delay. Startups that delay strategically seem to enter venture capital in a more developed state, engage in less post-financing repositioning, and face a tradeoff between exit quality and acquisition likelihood.
